<x-site.layout :title="app()->getLocale() === 'en' ? 'About Us — PT 4Putra Vertex Aviary' : 'Tentang Kami — PT 4Putra Vertex Aviary'" :description="app()->getLocale() === 'en' ? 'The journey of PT 4Putra Vertex Aviary since 2019 in West Surabaya: from lovebirds breeding to premium macaws.' : 'Perjalanan PT 4Putra Vertex Aviary sejak 2019 di Surabaya Barat: dari penangkaran lovebirds hingga macaw premium.'">
    ...
    <section class="w-full px-6 md:px-12 lg:px-16 pb-10 pt-10 bg-[#F3F4F6] dark:bg-gray-800">
        <h2 class="text-4xl font-bold text-slate-800 dark:text-slate-100 text-center">
            {{ __('about.team_title') }}
    ...
    <section id="contact" class="scroll-mt-28 md:scroll-mt-36 bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            ...
            <div class="text-center mb-12">
                <h2 class="mt-2 text-3xl font-bold text-gray-900 dark:text-white md:text-4xl">{{ __('contact.hero_welcome') }} <span
                        class="text-[#E62C37]">{{ __('contact.hero_welcome2') }}</span></h2>
