...
<head>
    ...
    <title>Daftar - 4Putra Vertex Aviary</title>
...
<body class="min-h-screen bg-gray-50 flex flex-col items-center justify-center antialiased">
    ...
    <div class="w-full max-w-md px-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <h1 class="text-2xl font-bold text-gray-800 text-center mb-6">Buat Akun Baru</h1>
            ...
            <form method="POST" action="{{ route('register') }}" autocomplete="off" novalidate>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus
                        autocomplete="off" placeholder="Jhon Doe"
                        class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E62C37]/30 focus:border-[#E62C37] transition-colors duration-200 text-sm @error('name') border-red-500 @enderror">
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required
                        autocomplete="off" placeholder="user@example.com" readonly
                ...
                <div class="mb-6">
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <input :type="show ? 'text' : 'password'" name="password_confirmation"
                            ...
                            class="w-full px-4 py-3 pr-12 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E62C37]/30 focus:border-[#E62C37] transition-colors duration-200 text-sm">
                        <button type="button" @click="show = !show"
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-[#E62C37] hover:text-[#c7242f] font-medium">Masuk di
                    sini</a>
            </p>
        </div>
