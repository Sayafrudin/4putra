<x-layout>
    <div class="grow flex flex-col items-center justify-center text-sm max-md:px-4 pt-24 md:pt-32 w-full">
        <h1 class="text-8xl md:text-9xl font-black text-[#E62C37]">Contact</h1>
        <div class="h-1 w-16 rounded bg-[#E62C37] my-5 md:my-7"></div>
        <p class="text-2xl md:text-3xl font-bold text-gray-800">Halaman Masih Dalam Pengembangan</p>
